---
title: "Mississippi State Scouting Report"
output: pdf_document
date: "2022-12-21"
---
...
```{r}
mst_schedule <- gamezoneR::gamezone_mbb_team_schedule(team = "Mississippi State", season = "2022-23")
```

```{r, message=FALSE}
mst_pbp <- purrr::map_df(mst_schedule$game_id, 
...
gamezoneR::base_court +
  ...
  labs(title = "Mississippi State Bulldogs Shot Chart",
